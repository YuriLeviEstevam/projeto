...
function page_form(string $flash = '', array $old = []): string
{
  ...
  $email = h($old['email'] ?? '');
  return <<<HTML
<!doctype html><html lang="pt-br"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Cadastro de Pacientesv1</title>
